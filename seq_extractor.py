...
# This script takes a list of read header names, from reads that need to be extracted from a
# multifasta reads file, and writes a new fasta file that only contains the reads on the reads list.  
